...
$canvasClass = $modalOptions['canvasClass'] ?? 'col-8';
$panelClass = $modalOptions['panelClass'] ?? 'col-4';
$sizeDisp = $modalOptions['sizeDisp'] ?? true;
$posDisp = $modalOptions['posDisp'] ?? true;
$sizeDispClass = $modalOptions['sizeDispClass'] ?? 'col-12';
$posDispClass = $modalOptions['posDispClass'] ?? 'col-8';
    ...
    <div class="modal-dialog <?= $modalClass ?>" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="mb-3 <?= $canvasClass ?>">
                        <div class="modal-canvas"><img id="cropper-image-<?= $unique ?>" src="" alt=""/></div>
                    </div>
                    <div class="mb-3 <?= $panelClass ?>">
                        <div class="row">
                            <?php if ($sizeDisp) : ?>
